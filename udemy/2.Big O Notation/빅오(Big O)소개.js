...
/* 
    ...
    생각보다 더 오랜 시간이 걸리거나, 브라우저에서 함수를 실행했을 때 컴퓨터가 렉걸린다 생각해보자.
...
/* 
    ...
    3) 빠른 알고리즘에서는 정말 짧은 시간 안에 모든 것이 처리 된다는 것. 이런 경우는 속도 측정 정확도가 충분하지 않을 수 있다.
...
// 위의 코드에서 반복되면서 배열의 크기가 늘어나서 무한대에 가까워질수록 공간 복잡도가 어떻게 되는지?
...
/* 
    ...
    4) 빅오로 측정되는 알고리즘의 시간과 공간 복잡도는 하드웨어에 영향을 받지 않는다.
